...
import 'package:projeto_final/view/animal_three_naming_page.dart';

class AnimalTwoNamingPage extends StatefulWidget {
  const AnimalTwoNamingPage({super.key});
  
  @override
  _AnimalTwoNamingPageState createState() => _AnimalTwoNamingPageState();
}

class _AnimalTwoNamingPageState extends State<AnimalTwoNamingPage> {
      ...
      body: Column(
        children: [
          ...
          Center(child: Padding(padding: const EdgeInsets.only(top:50.0),
            child: Image.asset('assets/images/animal_two.png', height: 250, width: 350))
          ),
          Padding(
