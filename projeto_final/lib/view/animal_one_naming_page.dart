...
import 'package:projeto_final/view/animal_two_naming_page.dart';

class AnimalOneNamingPage extends StatefulWidget {
  const AnimalOneNamingPage({super.key});
  
  @override
  _AnimalOneNamingPageState createState() => _AnimalOneNamingPageState();
}

class _AnimalOneNamingPageState extends State<AnimalOneNamingPage> {
      ...
      body: Column(
        children: [
          ...
          Center(child: Padding(padding: const EdgeInsets.only(top:50.0),
            child: Image.asset('assets/images/animal_one.png', height: 250, width: 350))
          ),
          Padding(
          ...
          Padding(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const AnimalTwoNamingPage()),
             );
            },
            child: const Row(
