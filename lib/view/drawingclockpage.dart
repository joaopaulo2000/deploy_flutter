...
import 'package:moca_geriuff_user_interface/components/iconbox.dart';
import 'package:moca_geriuff_user_interface/components/newstopwatch.dart';
import 'package:moca_geriuff_user_interface/components/drawingcanvas/drawingcanvas.dart';
import 'package:moca_geriuff_user_interface/components/drawingcanvas/drawingmode.dart';
import 'package:moca_geriuff_user_interface/components/drawingcanvas/sketch.dart';
import 'package:moca_geriuff_user_interface/view/drawingpointspage.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
import 'package:provider/provider.dart';
import 'package:screenshot/screenshot.dart';

class DrawingClockPage extends HookWidget {
  DrawingClockPage({Key? key}) : super(key: key);
        ...
        body: SingleChildScrollView(
          ...
          const Padding(
              ...
              child: Column(
                children: <Widget>[
                  Center(
                      child: Text("Desenhe um relógio",
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 25))),
                  SizedBox(height: 10),
                  Center(
                      child: Text("(Onze horas e dez minutos)",
                          style: TextStyle(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (imageBytes != null) {
                            String imageName = 'screenshotClock_$testId.png';
                          ...
                          onPressed: () async {
                            if (saveButtonPressed == true) {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => DrawingPointsPage()),
                              );
                            } else {
                              showDialog(
                                  context: context,
